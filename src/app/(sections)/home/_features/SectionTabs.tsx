...
interface Props {
  ...
  quotes: ListResponse<PlainQuotesWithRelations>;
...
export default function SectionTabs({
  ...
  const items: TabsProps["items"] = [
    {
      ...
      children:
        quotes.success === null ? (
          ...
          <QuotesList data={quotes.data} totalItem={quotes.total} />
        ) : (
  ...
  return (
    <div className="w-full bg-[#f7f7f8] px-3 pt-7 pb-6 sm:px-12">
      <div className="bg-white rounded-2xl p-4 mb-6 shadow-xl w-full max-w-7xl mx-auto">
        <Tabs
